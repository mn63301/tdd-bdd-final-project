...
class TestProductModel(unittest.TestCase):
    ...
    def test_update_with_no_id(self):
        """It should Return an Error for updating products with no id"""
        # Test exception with no id
        product = ProductFactory()
        product.id = None
    ...
    def test_update_a_product(self):
        ...
        product.description = "new_prod"
        # Assert that the id is same as the original id but description property of the product object has been
        # updated correctly after calling the update() method.
        original_id = product.id
        product.update()
        self.assertEqual(product.id, original_id)
        self.assertEqual(product.description, "new_prod")
        ...
        self.assertEqual(products[0].description, "new_prod")
    ...
    def test_delete_a_product(self):
        ...
        product.create()
        # Assert  if the length of the list returned by Product.all() is equal to 1, to verify that
        # after creating a product and saving it to the database, there is only one product in the system.
        self.assertEqual(len(Product.all()), 1)
        # Call the delete() method on the product object, to remove the product from the database.
        product.delete()
        # Assert if the length of the list returned by Product.all() is now equal to 0, indicating that
    ...
    def test_list_all_products(self):
        ...
        self.assertEqual(products, [])
        # Use for loop to create five Product objects using a ProductFactory() and call the create() method
        ...
        products = Product.all()
        # Assert if the length of the products list is equal to 5, to verify that the five products created
        # in the previous step have been successfully added to the database.
        self.assertEqual(len(products), 5)

    def test_find_by_name(self):
        """It should Find a Product by Name"""
        products = ProductFactory.create_batch(5)
        # Use a for loop to iterate over the products list and call the create() method on each product
    ...
    def test_find_by_availability(self):
        ...
        # the length of the filtered list, and use the variable called count to hold the number of products
        ...
        # that have the specified availability.
        db_product = Product.find_by_availability(available)
        # Assert if the count of the found products matches the expected count.
        self.assertEqual(db_product.count(), count)
    ...
    def test_find_by_price(self):
        ...
        # Call the find_by_price() method on the Product class to retrieve products from the database
        # that have the specified price.
        db_product = Product.find_by_price(price)
        # Assert if the count of the found products matches the expected count.
        self.assertEqual(db_product.count(), count)
        # Use a for loop to iterate over the found products and assert that each product's price
        # matches the expected availability, to ensure that all the retrieved products have the correct price.
        for product in db_product:
    ...
    def test_find_by_category(self):
        ...
        # Use a list comprehension to filter the products based on their category and then use len() to calculate
        # the length of the filtered list, and use the variable called count to hold the number of products
        # that have the specified category.
        count = len([product for product in products if product.category == category])
        # Call the find_by_category() method on the Product class to retrieve products from the database
        # that have the specified category.
