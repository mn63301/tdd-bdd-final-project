...
class TestProductRoutes(TestCase):
    ...
    def test_get_product(self):
        ...
        # make a self.client.get request to the API endpoint and store the result
        # in the variable named response
        test_product = self._create_products(1)[0]
    ...
    def test_query_by_name(self):
        ...
        # and checks if each product's name matches the test_name
        for product in data:
    ...
    def test_query_by_category(self):
        ...
        # retrieves the category of the first product in the products list
        # and assigns it to the variable category
        category = products[0].category
        # create a list named found, containing products from the products list
        # whose category matches the category variable
        ...
        data = response.get_json()
        # assert that the length of the data list
        # (i.e., the number of products returned in the response) is equal to found_count
        self.assertEqual(len(data), found_count)
        # use a for loop to check each product in the data list and
        # verify that all returned products belong to the queried category
        for product in data:
    ...
    def test_query_by_availability(self):
        ...
        products = self._create_products(10)
        # list named available_products is initialized to store the products based on
        ...
        data = response.get_json()
        # assert that the length of the data list
        # (i.e., the number of products returned in the response) is equal to available_count
        self.assertEqual(len(data), available_count)
        # use a for loop to check each product in the data list and
        # verify that the "available" attribute of each product is set to True
        for product in data:
