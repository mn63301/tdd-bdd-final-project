...
def list_products():
    ...
    # If you did, call the Product.find_by_name(name) method to retrieve products
    ...
    # call the Product.find_by_availability(available_value) method to retrieve products
    # that match the specified available_value
